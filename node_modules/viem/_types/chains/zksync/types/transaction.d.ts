...
export type TransactionRequestEIP712<TQuantity = bigint, TIndex = number, TTransactionType = 'eip712'> = TransactionRequestBase<TQuantity, TIndex> & Partial<FeeValuesEIP1559<TQuantity>> & {
    accessList?: never;
    gasPerPubdata?: bigint;
    factoryDeps?: Hex[];
    paymaster?: Address;
